...
- Lets you pin an individual Text Note PiP so it remains visible when another window receives focus. New notes start unpinned by default, or can remember the previous pin state when enabled in Settings.
