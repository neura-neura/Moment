...
Download the current Windows installer from the public [Moment v1.2.5 release](https://github.com/neura-neura/Moment/releases/tag/v1.2.5). Choose `MomentSetup-x64.exe` from the release assets.
