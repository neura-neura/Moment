...
Download the current Windows installer from the public [Moment v1.2.4 release](https://github.com/neura-neura/Moment/releases/tag/v1.2.4). Choose `MomentSetup-x64.exe` from the release assets.
