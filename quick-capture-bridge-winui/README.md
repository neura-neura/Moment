...
Download the current Windows installer from the public [Moment v1.2.3 release](https://github.com/neura-neura/Moment/releases/tag/v1.2.3). Choose `MomentSetup-x64.exe` from the release assets.
